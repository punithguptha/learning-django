This project is about having users to enter some text in our site and then internally we apply some hashing algorithm and convert that text to the hashed code and display on the site.
