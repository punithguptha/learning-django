"""
Django settings for ExpenseTrackerApi project.
...
import environ,os,pdb
import datetime

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

# For accessing environment variables/secrets via django-environ package
env=environ.Env()
...
ROOT_URLCONF = 'ExpenseTrackerApi.urls'
...
WSGI_APPLICATION = 'ExpenseTrackerApi.wsgi.application'
...
# Settings for djangorestframework-simplejwt package
SIMPLE_JWT = {
...
# Email configuration for sending the mails
EMAIL_USE_TLS=True
